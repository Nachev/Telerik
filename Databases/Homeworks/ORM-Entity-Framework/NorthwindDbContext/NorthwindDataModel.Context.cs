...
namespace NorthwindDbContext
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> uspTotalIncomesForSupplierInPeriod(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("uspTotalIncomesForSupplierInPeriod", supplierNameParameter, startDateParameter, endDateParameter);
        }
    }
}
