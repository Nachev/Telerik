...
window.onload = function() {
    var coursesTemplateHtml = null,
        coursesTemplate = null,
        tableData = {
            header: {
                "secondCol": "Title",
                "thirdCol": "Date #1",
    ...
    coursesTemplateHtml = document.getElementById('table-template').innerHTML;
    coursesTemplate = Handlebars.compile(coursesTemplateHtml);
    document.getElementById('root').innerHTML = coursesTemplate(tableData);
};