...
{  
    ...
    public class Program
    {
        ...
        static void StartScreen()
        {
            ...
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine("To move use arrow keys. Avoid ghosts and collect all the gold as quickly as possible. You got 5 lives. If the ghosts catch you, you loose life. When all lifes are lost your game is over. If you succeed to get all the gold and your timing is good you will enter in Hall of fame :)");
        ...
        static int[] Chase1(string[,] maze, int ghostX, int ghostY, int pacX, int pacY)
        {
            int[] distancesSq = 
                                { 
            ...
            int[] sortedSq = new int[4];
            Array.Copy(distancesSq, sortedSq, 4);
            Array.Sort(sortedSq);
            int[] sortedIndexes = new int[4];
            for (int i = 0; i < 4; i++)
            {
                sortedIndexes[i] = Array.IndexOf(distancesSq, sortedSq[i]);
            }

            // int minIndex = Array.IndexOf(SqDistances, SqDistances.Min());
            // Console.WriteLine("{0},{1},{2}", sortedIndexes[0], sortedIndexes[1], sortedIndexes[2]);
            return sortedIndexes;
        }

        static int[] Chase2(string[,] maze, int ghostX, int ghostY, int pacX, int pacY)
        {
        ...
        static int[] Chase3(string[,] maze, int ghostX, int ghostY, int pacX, int pacY)
        {
            pacX += pacX - ghostX;
            pacY += pacY - ghostY;
            return Chase1(maze, ghostX, ghostY, pacX, pacY);
        ...
        static int[] Chase4(string[,] maze, int ghostX, int ghostY, int pacX, int pacY)
        {
