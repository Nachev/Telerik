...
However, none of these approaches actually persister thrown exceptions.  The
...
In this particular iteration of the design, we'll persister a promise as an object
...
the value of the promised result.  This fails to persister the fact that a
