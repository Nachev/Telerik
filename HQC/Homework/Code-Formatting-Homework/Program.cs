namespace Events
{
    ...
    public class Program
    {
        ...
        private static void Main(string[] args)
        {
            while (true)
            {
                bool breaker = ExecuteNextCommand();
                if (breaker)
                {
                    break;
                }
        ...
        {
            const string EventAddedMessage = "Event added";
            const string NoEventFoundMessage = "No events found";
            const string EventDeletedFormat = "{0} events deleted";
            ...
            public static void EventDeleted(int x)
            {
                ...
                {
                    output.AppendFormat(EventDeletedFormat, x);
                    output.AppendLine();
                }
            }
            ...
            {
                output.AppendLine(NoEventFoundMessage);
            }
