namespace T09.LargestCommonArea
{
    using System;
    ...
    internal class SampleProgram
    {
        ...
        private static IList<Coordinate> largestArea = new List<Coordinate>();
        ...
        public static void Main(string[] args)
        {
            ...
            for (int r = 0; r < matrix.GetLength(0); r++)
            {
                for (int c = 0; c < matrix.GetLength(1); c++)
                {
                    if (matrix[r, c])
                    {
                        ...
                        // Check if largest area was found
                        if (area.Count > largestArea.Count)
                        {
                            largestArea = new List<Coordinate>();
                            foreach (Coordinate coord in area)
                            {
                                largestArea.Add(coord);
                            }
                        }
            ...
            foreach (var item in largestArea)
            {
