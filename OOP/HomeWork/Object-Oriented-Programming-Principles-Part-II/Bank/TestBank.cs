namespace Bank
{
     ...
     * its is calculated as follows: number_of_months * interest_rate. Loan accounts have no interest 
     * for the first 3 months if are held by individuals and for the first 2 months if are held by a 
     * company.
